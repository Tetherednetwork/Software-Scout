                ...
                <div className="p-8 overflow-y-auto">
                    ...
                    <PolicySection title="3. How We Comply">
                         ...
                         <ul className="list-disc list-inside space-y-2">
                            ...
                            <li><strong>Data Processing:</strong> For the chat functionality, your conversation history (containing your requests for software, games, drivers, and guides across various platforms) is sent to the Google Gemini API to generate responses. We do not include your personal profile information (name, email) in these API requests.</li>
