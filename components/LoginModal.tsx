                        ...
                        <>
                            {viewMode === 'resetPassword' ? (
                                <form onSubmit={handlePasswordReset} className="mt-6 space-y-4">
                                    <div>
                                        <label htmlFor="email-legacy-reset" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                                        <input
                                            id="email-legacy-reset" type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                ...
                                <form onSubmit={handleAuth} className="mt-6 space-y-4">
                                    <div>
                                        <label htmlFor="email-legacy" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                                        <input
                                            id="email-legacy" type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                                            className="w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg p-3 focus:ring-2 focus:ring-[#4F8A54] focus:outline-none"
                                            placeholder="you@example.com" required
                                        />
                                    </div>
                                    ...
                                    {viewMode === 'signUp' && (
                                        <>
                                            <div>
                                                <label htmlFor="confirm-password-legacy" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Confirm Password</label>
                                                <input
                                                    id="confirm-password-legacy" type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}
                                                    className="w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg p-3 focus:ring-2 focus:ring-[#4F8A54] focus:outline-none"
                                                    placeholder="••••••••" required
                                                />
                                            </div>
                                            <div>
                                                <label htmlFor="user_role_legacy" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">I am a...</label>
                                                <select
                                                    id="user_role_legacy" name="user_role" value={userRole} onChange={(e) => setUserRole(e.target.value)}
