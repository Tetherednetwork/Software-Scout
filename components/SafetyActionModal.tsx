...
import { CloseIcon, RestoreIcon, CleanIcon, VirusScanIcon, UpdateIcon, KeyboardIcon, UserPlusIcon, ShieldExclamationIcon, LockIcon, CloudUploadIcon, SpotlightIcon, ScreenshotIcon, GatekeeperIcon, TimeMachineIcon, MissionControlIcon, AirdropIcon } from './Icons';
            ...
            <div className="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 text-left relative flex flex-col max-h-[90vh]">
                <div className="p-6 border-b border-gray-200 dark:border-gray-700 flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">Follow these steps to perform this action safely.</p>
                    </div>
