        ...
        <div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
            <form onSubmit={handleSubmit} className="flex items-center gap-4">
                ...
                <textarea
                    ...
                    className="flex-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400 rounded-lg p-3 focus:ring-2 focus:ring-[#4F8A54] focus:outline-none resize-none"
                    rows={1}
                    disabled={isLoading}
                />
                <button
