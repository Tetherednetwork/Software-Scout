...
import { UserIcon, BotIcon, DownloadIcon, LinkIcon, SoftwareIcon, WrenchIcon, ShieldCheckIcon, YouTubeIcon, AppleIcon, LinuxIcon, AndroidIcon, GameIcon, WindowsIcon, ClipboardIcon } from '../ui/Icons';
...
const MessageItem: React.FC<MessageItemProps> = ({ message, onOptionSelect, isLatestBotMessage, onDownload, userAvatarUrl }) => {
    const { id, text, sender, groundingChunks, type, platform } = message;
    ...
    const formatText = (inputText: string) => {
        ...
        formattedText = formattedText.replace(sha256Regex, (match, prefix, hash) => {
