...
const SocialProof: React.FC = () => {
    return (
        <div className="flex items-center gap-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-2 rounded-full shadow-lg border border-gray-200 dark:border-gray-700 w-fit mb-8" aria-live="polite">
