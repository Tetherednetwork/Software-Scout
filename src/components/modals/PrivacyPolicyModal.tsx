            ...
            <div className="w-full max-w-3xl bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 text-left relative flex flex-col max-h-[90vh]">
                ...
                <div className="p-8 overflow-y-auto">
                    ...
                    <PolicySection title="3. How We Use Your Information">
                        <ul className="list-disc list-inside space-y-2">
                            <li><strong>To Provide the Service:</strong> Your chat history is sent to the Google Gemini API to generate relevant responses for your cross-platform software, game, driver, and installation guide inquiries.</li>
                            <li><strong>To Personalize Your Experience:</strong> Your account information is used to display your profile and associate your chat history with you.</li>
                             <li><strong>For Functionality:</strong> All collected data (profile, chat history, feedback) is stored locally in your browser's <code>localStorage</code>. This allows the application to function without needing a backend server.</li>
                        </ul>
                    </PolicySection>

                    <PolicySection title="4. Data Sharing and Third Parties">
                         <ul className="list-disc list-inside space-y-2">
                            <li><strong>Google Gemini API:</strong> To generate responses, your chat history is sent to Google's Gemini API for processing. We do not send your personal profile information (name, email) with these requests.</li>
                     ...
                     <PolicySection title="5. Data Storage, Security, and Retention">
                         <ul className="list-disc list-inside space-y-2">
                            <li><strong>Local Storage:</strong> Your user profile, chat history, and feedback are stored directly in your web browser's <code>localStorage</code>. This data is not transmitted to or stored on our servers.</li>
                            <li><strong>Security:</strong> Data stored in <code>localStorage</code> is only as secure as the computer and browser you are using. No method of electronic storage is 100% secure.</li>
                            <li><strong>Retention and Deletion:</strong> Your data remains in your browser until you clear it. You can delete all your data by clearing your browser's cache and site data for this domain.</li>
                        </ul>
                    </PolicySection>

                    <PolicySection title="6. Your Data Protection Rights Under GDPR">
                        <p>As a user, you have rights over your data. The primary method to exercise these rights is by managing your browser's local storage.</p>
                         <ul className="list-disc list-inside space-y-2">
                            <li><strong>The right to access & erasure:</strong> You can access and delete all your data at any time by clearing your browser's <code>localStorage</code> for our site.</li>
                            <li><strong>The right to rectification:</strong> You can manage your profile information at its source (e.g., your Google Account).</li>
                        </ul>
                    </PolicySection>
