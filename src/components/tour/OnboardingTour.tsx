...
const tourSteps: TourStep[] = [
    {
        ...
        title: "1. Start Here: Your AI Assistant",
        content: "This is where the magic happens! Ask for any software, game, or driver. For example, try 'Find a free photo editor for Windows'.",
        position: 'top',
    },
    {
        selector: '[data-tour-id="trending-topics"]',
        title: "2. Get Inspired",
        content: "Not sure what you need? Check out what's currently trending in the software world. Click any item to start a search instantly.",
        position: 'right',
    },
    {
        selector: '[data-tour-id="software-filters"]',
        title: "3. Refine Your Search",
        content: "Looking for something specific? Use these filters to narrow down your results by price, such as 'Free' or 'Paid' software.",
        position: 'bottom',
    },
    {
        selector: '[data-tour-id="file-verifier-link"]',
        title: "4. Verify Your Downloads",
        content: "Our AI provides file hashes for safety. You can use our File Verifier to check if a downloaded file is authentic and hasn't been tampered with.",
        position: 'bottom',
    },
    {
        selector: '[data-tour-id="download-history"]',
        title: "5. Keep Track of Downloads",
        content: "When you're signed in, every piece of software you download through SoftMonk is saved here for easy access later.",
        position: 'bottom',
    },
    {
        selector: '[data-tour-id="header-profile-link"]',
        title: "6. Save Your Progress",
        content: "Sign in to save your chat history and download records. You can also manage your profile and saved devices here.",
        position: 'bottom',
    },
    {
        selector: '[data-tour-id="safety-actions"]',
        title: "7. Stay Safe & Secure",
